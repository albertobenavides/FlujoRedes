...
set size square
unset colorbox
set title'Ejemplo 5. Arcos con etiqueta'
...
set arrow 1 from 0.1,0.0 to 0.9,0.0 linewidth 5 nohead
set label '5' at 0.5,0.03 left offset char -0.4,0
set arrow 2 from 0.07071067811865475,0.07071067811865475 to 0.9292893218813453,0.9292893218813453 linewidth 7 nohead
set label '7' at 0.43,0.47 left offset char -0.4,0
set arrow 3 from 0.9,0.0 to 0.1,0.0 linewidth 5 nohead
set label '5' at 0.5,0.03 left offset char -0.4,0
set arrow 4 from 1.0,0.1 to 1.0,0.9 linewidth 2 nohead
...
set arrow 6 from 1.0,0.9 to 1.0,0.1 linewidth 2 nohead
set label '2' at 0.97,0.5 left offset char -0.4,0
set arrow 7 from 0.9292893218813453,0.9292893218813453 to 0.07071067811865475,0.07071067811865475 linewidth 7 nohead
set label '7' at 0.43,0.47 left offset char -0.4,0
set arrow 8 from 0.9,1.0 to 0.1,1.0 linewidth 4 nohead
set label '4' at 0.5,1.03 left offset char -0.4,0
set arrow 9 from 0.07071067811865475,0.9292893218813453 to 0.9292893218813453,0.07071067811865475 linewidth 3 nohead
set label '3' at 0.5700000000000001,0.47 left offset char -0.4,0
set arrow 10 from 0.1,1.0 to 0.9,1.0 linewidth 4 nohead
set label '4' at 0.5,1.03 left offset char -0.4,0
